...
from domain.prompts import TOPIC_SENTENCE_SYSTEM_PROMPT, TOPIC_SENTENCE_SYSTEM_PROMPT_V2, QUOTATION_SYSTEM_PROMPT
...
def topic_sentence(input_data: InputData):
    ...
    try:
        messages = generate_simple_message(
            system_prompt=TOPIC_SENTENCE_SYSTEM_PROMPT_V2,
