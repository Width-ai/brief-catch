import tiktoken
from prompts import SENTENCE_RANKING_SYSTEM_PROMPT, USER_TEXT_EXAMPLES, CONDENSED_SENTENCE_RANKING_SYSTEM_PROMPT
...
AVG_OUTPUT = "5 - The revised sentence replaces on at least 24 occasions with"
...
def calc_cost(string: str, model_name: str = "gpt-4") -> float:
    """Gets the number of tokens then looks up the cost per token for the model"""
    input_tokens = num_tokens_from_string(string=SENTENCE_RANKING_SYSTEM_PROMPT + string)
