...
SYSTEM_PROMPT = """
You will be given an original rule as Input 3, an action to take and specificities around the action in the user text. Modify the original rule according to based on the action and following the below instructions:
